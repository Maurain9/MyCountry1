# MyCountry1
MyCountry est une application androide permettant de signaler les incidents et catastrophes naturels pour une intervention plus rapide des autorités compétentes. 
	************************************
...
1) 	A l'aide de votre interpretteur de commande (cmd.exe),
	...
	le fichier compressé "MyCountry.jar"
	('cd [chemin]/[dossier cible]').

2)	Entrer la commande 'java -jar MyCountry.jar'.
